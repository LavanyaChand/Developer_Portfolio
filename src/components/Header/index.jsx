  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/LavanyaChand" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/lavanyachand/" target={"_blank"} rel="noopener noreferrer">
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 4 }} className="header--bottom">
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              Hey there!!! I’m Lavanya, a Frontend Developer who loves turning ideas into smooth, interactive apps. Whether it’s coding sleek UIs in React, experimenting with animations, or sketching out designs in Figma, I enjoy blending creativity with clean code. I’m all about building experiences that not only work great but feel great to use
            </ScrambleText>
          </p>
        </div>
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Lavanya Chand"} noblink />
        <br />
